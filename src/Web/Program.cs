...
var orderDeliveryProcessorFnUri = builder.Configuration["OrderDeliveryProcessorFnUri"];
var orderDeliveryProcessorFnKey = builder.Configuration["OrderDeliveryProcessorFnKey"];

builder.Services.AddHttpClient("DeliveryOrderProcessorClient", client =>
{
    client.BaseAddress = new Uri(orderDeliveryProcessorFnUri);
    client.DefaultRequestHeaders.Add("x-functions-key", orderDeliveryProcessorFnKey);
});



builder.Services.AddScoped<IOrderSenderService, OrderSenderService>(provider => new OrderSenderService(builder.Configuration["ServiceBusConnection"], builder.Configuration["ServiceBusQueue"]));
builder.Services.AddScoped<IDeliverySenderService, DeliverySenderService>();
